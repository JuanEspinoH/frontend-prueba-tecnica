...
export const GlobalStoreaProvider = ({ children }) => {
  ...
  const self = async () => {
    ...
    try {
      const response = await fetch(
        import.meta.env.VITE_BACKEND_API_URL + '/self',
        {
          method: 'GET',
          headers: {
  ...
  const recuperarContra = async (body) => {
    try {
      const response = await fetch(
        import.meta.env.VITE_BACKEND_API_URL + '/recuperar-contraseña',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  const reescribirContraCheck = async (body) => {
    try {
      const response = await fetch(
        import.meta.env.VITE_BACKEND_API_URL + '/reescribir-contraseña',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  const reescribirContraForm = async (body) => {
    try {
      const response = await fetch(
        import.meta.env.VITE_BACKEND_API_URL + '/reescribir-contraseña-form',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
